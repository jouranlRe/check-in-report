...
new Chart(document.getElementById('trendSpeciesChart'),{type:'line',data:{labels:["1\u6708", "2\u6708", "3\u6708", "4\u6708", "5\u6708", "6\u6708", "7\u6708", "8\u6708", "9\u6708", "10\u6708", "11\u6708", "12\u6708"],datasets:[{label:'中文',data:[52, 35, 87, 79, 63, 77, 1, 0, 93, 0, 0, 0],borderColor:'#3498db',backgroundColor:'rgba(52,152,219,0.08)',fill:true,tension:.4},{label:'外文',data:[2, 5, 5, 6, 5, 5, 0, 0, 6, 0, 0, 0],borderColor:'#e74c3c',backgroundColor:'rgba(231,76,60,0.08)',fill:true,tension:.4}]},options:{responsive:true,plugins:{legend:{position:'top',labels:{font:{size:11}}}},scales:{y:{beginAtZero:true,ticks:{stepSize:1}}}}});
new Chart(document.getElementById('trendIssuesChart'),{type:'line',data:{labels:["1\u6708", "2\u6708", "3\u6708", "4\u6708", "5\u6708", "6\u6708", "7\u6708", "8\u6708", "9\u6708", "10\u6708", "11\u6708", "12\u6708"],datasets:[{label:'中文',data:[75, 38, 204, 130, 71, 115, 1, 0, 281, 0, 0, 0],borderColor:'#3498db',backgroundColor:'rgba(52,152,219,0.08)',fill:true,tension:.4},{label:'外文',data:[3, 8, 14, 16, 12, 12, 0, 0, 31, 0, 0, 0],borderColor:'#e74c3c',backgroundColor:'rgba(231,76,60,0.08)',fill:true,tension:.4}]},options:{responsive:true,plugins:{legend:{position:'top',labels:{font:{size:11}}}},scales:{y:{beginAtZero:true,ticks:{stepSize:1}}}}});
...
window.showGridDetail=function(el){
  ...
  var at=document.querySelector('#grid-cn.active,#grid-foreign.active')||document.getElementById('grid-cn');
  var wrapper=at?at.querySelector('.grid-wrapper'):null;
  var fixedRows=wrapper?wrapper.querySelectorAll('.grid-fixed-row'):document.querySelectorAll('.grid-fixed-row');
